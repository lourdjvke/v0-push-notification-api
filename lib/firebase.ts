...
import { getDatabase, ref, set, get, remove, update, query, orderByChild, limitToLast } from 'firebase/database';
...
export { app, database, ref, set, get, remove, update, query, orderByChild, limitToLast };
